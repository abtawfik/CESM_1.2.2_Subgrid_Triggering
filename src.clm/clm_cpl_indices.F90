...
!
  ...
  integer, public ::index_l2x_Sl_convfrac     ! fraction of convection <===========  abt added
  ...
  integer, public ::index_x2l_Sa_tbm          ! convective threshold   !!!abt added
...
!-----------------------------------------------------------------------
    ...
    index_l2x_Sl_convfrac   = mct_avect_indexra(l2x,'Sl_convfrac')    !<======= abt added
    ...
    index_x2l_Sa_tbm        = mct_avect_indexra(x2l,'Sa_tbm')    !!abt added
