...
!-------------------------------------------------------------------------------
     ...
     !****  abt added below  ****
     !***************************
     ! potential temperature of the convective threshold (K)
     call seq_flds_add(a2x_states,"Sa_tbm")
     call seq_flds_add(x2l_states,"Sa_tbm")
     call seq_flds_add(x2i_states,"Sa_tbm")
     call seq_flds_add(x2w_states,"Sa_tbm")
     longname = 'Potential Temperature Convective Threshold'
     stdname  = 'threshold_temperature'
     units    = 'K'
     attname  = 'Sa_tbm'
     call metadata_set(attname, longname, stdname, units)
     !***************************
     ...
     !***************************
     ! Convective fraction
     call seq_flds_add(l2x_states,"Sl_convfrac")
     call seq_flds_add(i2x_states,"Si_convfrac")
     call seq_flds_add(xao_states,"So_convfrac")
     call seq_flds_add(x2a_states,"Sx_convfrac")
     longname = 'Convective fraction'
     stdname  = 'convective_fraction'
     units    = 'unitless'
     attname  = 'Si_convfrac'
     call metadata_set(attname, longname, stdname, units)
     attname  = 'Sl_convfrac'
