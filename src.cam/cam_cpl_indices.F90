module cam_cpl_indices
  ...
  integer :: index_a2x_Sa_tbm          ! convective threshold used to trigger (K)  abt added
  ...
  integer :: index_x2a_Sx_convfrac     ! fraction grid with convection abt added
...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    index_x2a_Sx_convfrac   = mct_avect_indexra(x2a,'Sx_convfrac')    !abt added
